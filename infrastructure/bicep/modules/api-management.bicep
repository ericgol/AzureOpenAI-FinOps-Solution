...
// Note: FinOps telemetry policy is applied separately via apim-finops-policy.bicep
// This ensures proper deployment order after EventHub logger is configured
